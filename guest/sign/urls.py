...
from sign.api import views_search_event
from sign.api import views_add_event
from sign.api import views_add_guest

app_name = "sign"
urlpatterns = [
    path("add_event", views_add_event.add_event, name="add_event"),
    path("search_event", views_search_event.search_event, name="search_event"),
    path(r'add_guest/', views_add_guest.add_guest, name="add_guest"),
